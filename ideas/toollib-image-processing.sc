...
(define (load-edges-and-corners-phasecong2 location) (panic "matlab"))

(define (matlab-edges-phasecong2->pgm location)
 (panic "matlab"))

(define (find-edges-and-corners-phasecong pgm . params) (panic "matlab"))

(define (matlab-edge-orientation-hough
		 e o orientation draw? scaling threshold)
 (panic "matlab"))

(define (pgm->phase-congruency pgm) (panic "matlab"))
...
(define (ffmpeg fps frame destination)
 ...
 (let ((cmd (format #f "ffmpeg -y -r ~a -i  '~a' -vb 3000000 '~a' ~a" fps frame destination
                    (if (not *quiet-mode?*)
...
(define (turbopixels-load video-name) (panic "matlab"))

(define (turbopixels-for-frame f) (panic "matlab"))
...
(define (turbopixels-motion thresh frame) (panic "matlab"))

(define (turbopixels-names) (panic "matlab"))

(define (turbopixels-area) (panic "matlab"))

(define (turbopixels-speed) (panic "matlab"))

(define (turbopixels-centers) (panic "matlab"))

(define (turbopixels-speed-reliable?) (panic "matlab"))
...
(define (superpixel->matlab-closure-map s output w h) (panic "matlab"))
...
;; ;;added from toollib-image-processing in imitate
