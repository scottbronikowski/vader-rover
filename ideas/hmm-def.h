...
enum part_of_speech {NOUN, VERB, ADVERB, ADJECTIVE, PREPOSITION, MOTION_PREPOSITION, OTHER, VERB0, VERB1};

enum training_mode {HMM_ML, HMM_DT, HMM_MIXED};

enum model_constraint {NO_DUPLICATE_MODELS, NO_MODEL_CONSTRAINT};

enum state_constraint {TIE_STATES, NO_STATE_CONSTRAINT};
